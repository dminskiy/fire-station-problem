...
class Call:
    ...
    @property
    def assigned_to(self) -> Optional[Employee]:
    ...
    @property
    def assigned_at(self) -> Optional[datetime.datetime]:
        return self._info.assigned_at

    @assigned_at.setter
    def assigned_at(self, val: Optional[datetime.datetime]):
